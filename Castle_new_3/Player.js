...
// setup player health display //
    this.heroHealthBar=new HealthBar(this.game,{bar:{color:'#42f450'}});
    this.heroHealthBar.setPosition(220,80);
    this.heroHealthBar.setFixedToCamera(true);
    this.heroHealthBar.setPercent(this.health/80 * 100);
