...
var score=0,life=50,lifeString='',scoreString='',livingEnemies=[];
var hero,boss;
...
preload: function(){
  ...
  game.load.spritesheet('boss','assets/spritesheets/werewolfBoss.png',370,320);
  ...
  game.load.spritesheet('enemy','assets/spritesheets/werewolfMob.png',320,320);
